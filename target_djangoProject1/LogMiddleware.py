...
class RequestLogFilter(logging.Filter):
    ...
    def filter(self, record):
        ...
        record.server_name = getattr(local, 'server_name', 'none')
        record.http_user_agent = getattr(local, 'http_user_agent', 'none')
...
class RequestLogMiddleware(MiddlewareMixin):
    ...
    def __call__(self, request):
        ...
        local.server_name = request.META.get('SERVER_NAME', '')
        ...
        HTTP_USER_AGENT = request.user_agent.browser.family + ' ' + request.user_agent.os.family + request.user_agent.os.version_string
        # print(request.user_agent.os.family)
        # print(request.user_agent.os.version)
        local.http_user_agent = HTTP_USER_AGENT
